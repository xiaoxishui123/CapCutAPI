...
def create_working_draft():
    ...
    # 创建草稿目录结构
    draft_dir = f"./working_draft_{draft_id}"
    os.makedirs(draft_dir, exist_ok=True)
    
    # 创建.res目录结构（基于正常工作的草稿）
    ...
    draft_meta_info = {
        ...
        "draft_name": f"CapCutAPI工作草稿_{timestamp}",
        "draft_new_version": "",
...
def main():
    """主函数"""
    try:
        print("🎬 开始基于正常工作的草稿文件创建适配当前项目的草稿...")
        zip_filename = create_working_draft()
